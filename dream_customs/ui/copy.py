...
APP_COPY = {
    "en": {
        ...
        "notice_record": "Write one dream fragment, or choose a sample dream if you want the quick path.",
        ...
        "example_select_placeholder": "Choose a sample dream...",
        ...
        "demo_intro_label": "Sample dream",
        "demo_intro_body": "Choose one to fill the note and mood.",
        ...
        "side_stamp_title": "Pick a sample, answer or skip",
    ...
    "zh": {
        ...
        "notice_record": "写一个梦境片段；想快速体验，也可以从示例梦境里选一条。",
        ...
        "example_select_placeholder": "选择一个示例梦境...",
        "submit_button": "问一个问题",
        "processing_note": (
        ...
        "image_upload": "上传图片",
        "image_paste": "从剪贴板粘贴",
        "demo_intro_label": "示例梦境",
        "demo_intro_body": "选择一条会自动填入梦境记录和心情。",
