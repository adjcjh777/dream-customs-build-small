...
| --- | --- | ---: | --- | --- | --- | --- |
| ux01 train platform | `videos/2026-06-15-dreamqa-v2/ux01_full_ux.mp4` | 23.88s | `videos/2026-06-15-dreamqa-v2/ux01_evidence.json` | `videos/2026-06-15-dreamqa-v2/ux01_timeline.jpg` | `videos/2026-06-15-dreamqa-v2/ux01_final_ticket.png` | PASS |
| ux02 elevator buttons | `videos/2026-06-15-dreamqa-v2/ux02_full_ux.mp4` | 23.64s | `videos/2026-06-15-dreamqa-v2/ux02_evidence.json` | `videos/2026-06-15-dreamqa-v2/ux02_timeline.jpg` | `videos/2026-06-15-dreamqa-v2/ux02_final_ticket.png` | PASS |
| ux03 floating table | `videos/2026-06-15-dreamqa-v2/ux03_full_ux.mp4` | 26.16s | `videos/2026-06-15-dreamqa-v2/ux03_evidence.json` | `videos/2026-06-15-dreamqa-v2/ux03_timeline.jpg` | `videos/2026-06-15-dreamqa-v2/ux03_final_ticket.png` | PASS |
...
- `finalAnchors`
- `todayTipText`
- assertions for answer clue grounding, demo-specific cue grounding, honest voice fallback, no template tip phrase, and no safety-boundary leak.
